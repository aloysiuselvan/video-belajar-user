...
import { ChevronDown, ChevronUp, CheckCircle, CreditCard, Smartphone, Building, ShieldCheck, Video, FileText, Award, FileQuestion } from 'lucide-react';
...
const PaymentItem = ({ name, selected, onSelect }) => (
    <div
        onClick={onSelect}
        ...
        <div className="bg-surface font-sans min-h-screen pb-12">
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-12 pt-24 md:pt-32 flex flex-col lg:flex-row gap-12">
                <div className="flex-1">
                    ...
                    <h2 className="font-bold text-lg text-slate-900 mb-6">Ubah Metode Pembayaran</h2>

                    <PaymentOption title="Transfer Bank" icon={Building} isOpen={openSection === 'Transfer Bank'} onClick={() => toggleSection('Transfer Bank')}>
                    ...
                    <PaymentOption title="E-Wallet" icon={Smartphone} isOpen={openSection === 'E-Wallet'} onClick={() => toggleSection('E-Wallet')}>
                    ...
                    <PaymentOption title="Kartu Kredit/Debit" icon={CreditCard} isOpen={openSection === 'Kartu Kredit/Debit'} onClick={() => toggleSection('Kartu Kredit/Debit')}>
                        <PaymentItem name="Visa / Mastercard" selected={selectedPayment === 'Credit Card'} onSelect={() => setSelectedPayment('Credit Card')} />
                    </PaymentOption>

                    <Button onClick={handleSave} variant="primary" className="w-full bg-green-500 hover:bg-green-600 shadow-green-200 mt-6">
                        Bayar Sekarang
                    </Button>
                </div>
