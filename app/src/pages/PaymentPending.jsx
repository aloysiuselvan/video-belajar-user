        ...
        <div className="bg-surface font-sans min-h-screen pb-12">
            ...
            <div className="max-w-xl mx-auto px-4 md:px-6 pt-32 text-center flex flex-col items-center">
                <div className="w-64 h-64 mb-8">
                    <img src={illustration} alt="Pembayaran Tertunda" className="w-full h-full object-cover rounded-xl opacity-80" />
                </div>

                <h2 className="font-bold text-2xl text-slate-900 mb-4">Pembayaran Tertunda!</h2>
